...
using AvaloniaApplication1.MediaPlayer.Helpers;
using AvaloniaApplication1.MediaPlayer.Helpers.Mvvm;
using System;
...
namespace AvaloniaApplication1.MediaPlayer
{
            ...
            get
            {
                ...
                if (_uiParentCache == null)
                {
                    throw new NullReferenceException(string.Format(CultureInfo.InvariantCulture,
                        "{0} must be within a Panel or Grid control. Container is of type '{1}'.", UIPartName, UIPart?.Parent?.GetType()));
                }
